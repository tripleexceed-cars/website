...
export default function Marketplace() {
  ...
  const filteredVehicles = useMemo(() => {
    return MOCK_VEHICLES.filter(v => {
      ...
      return matchesSearch && matchesBrand && matchesSource && matchesCondition;
    });
  }, [search, selectedBrand, selectedSource, selectedCondition]);
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {filteredVehicles.length > 0 ? (
          ...
          <div className="py-24 text-center space-y-4">
            ...
            <button 
              onClick={() => { setSearch(''); setSelectedBrand('All'); setSelectedSource('All'); setSelectedCondition('All'); }}
